...
public class kasir extends javax.swing.JFrame {
    ...
    model.addTableModelListener(e -> {
        ...
        // Jika kolom yang berubah adalah kolom "Jumlah" (misalnya index ke-3)
        if (column == 3) {
            try {
                ...
                model.setValueAt(subtotal, row, 4); // update subtotal di kolom ke-4

                hitungTotal(); // update total keseluruhan
            } catch (NumberFormatException ex) {
                // Jika user salah input, reset ke 1
                model.setValueAt(1, row, 3);
                int harga = Integer.parseInt(model.getValueAt(row, 2).toString());
                model.setValueAt(harga, row, 4);
            }
        }
    });
        ...
        mButtonChoose.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke("F12"), "pilihMenu");
        mButtonChoose.getActionMap().put("pilihMenu", new AbstractAction() {
        @Override
        public void actionPerformed(java.awt.event.ActionEvent e) {
            mButtonChoose.doClick(); // seakan tombol diklik
        }
        });
        mButtonInven.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke("F11"), "kelolaMenu");
        mButtonInven.getActionMap().put("kelolaMenu", new AbstractAction() {
        @Override
        public void actionPerformed(java.awt.event.ActionEvent e) {
            mButtonInven.doClick(); // seakan tombol diklik
        }
        });
        btRiwayat.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke("F4"), "riwayat");
        btRiwayat.getActionMap().put("riwayat", new AbstractAction() {
        @Override
        public void actionPerformed(java.awt.event.ActionEvent e) {
            btRiwayat.doClick(); // seakan tombol diklik
        }
        });
    ...
    public void setNamaPelayan(String nama) {
...
private double getPersen(JTextField txt) {
    ...
    private void initComponents() {
        ...
        mButtonInven.setText("[F11] Kelola Menu");
        ...
        mButtonDel.setText("Delete");
        mButtonDel.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mButtonDelActionPerformed(evt);
            }
        });
        jPanel1.add(mButtonDel, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 10, -1, -1));
        ...
        tTunai.setText("Tunai :");
        jPanel1.add(tTunai, new org.netbeans.lib.awtextra.AbsoluteConstraints(1040, 80, -1, -1));
        ...
        jPanel1.add(tKembalian, new org.netbeans.lib.awtextra.AbsoluteConstraints(1020, 140, -1, -1));

        jKembalian.setEditable(false);
        jKembalian.setColumns(5);
        jPanel1.add(jKembalian, new org.netbeans.lib.awtextra.AbsoluteConstraints(1100, 140, -1, -1));
        ...
        btRiwayat.setText("[F4] Riwayat Transaksi");
        btRiwayat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btRiwayatActionPerformed(evt);
            }
        });
        jPanel1.add(btRiwayat, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 10, 190, -1));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(tTgl, javax.swing.GroupLayout.PREFERRED_SIZE, 143, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSaveActionPerformed
        // TODO add your handling code here:
         Date utilDate = tTgl.getDate();
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd"); // Ubah sesuai format yang kamu inginkan
